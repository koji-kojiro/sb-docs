## Generic-function: SB-PCL::MAKE-METHOD-INITARGS-FORM
...
### Lambda list
```cl
(sb-pcl::proto-generic-function sb-pcl::proto-method sb-pcl::lambda-expression
 sb-pcl::lambda-list sb-pcl::environment)
```
