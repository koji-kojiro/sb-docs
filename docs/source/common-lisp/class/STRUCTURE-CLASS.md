## Class: COMMON-LISP:STRUCTURE-CLASS
...
### Precedence list
```cl
(structure-class sb-pcl::slot-class sb-pcl::pcl-class class sb-pcl::dependent-update-mixin
...
### Initargs
```cl
(sb-pcl::source sb-pcl::plist :name :documentation sb-pcl::safe-p :from-defclass-p)
```
