## Function: SB-BSD-SOCKETS-INTERNAL::INET-NTOP
...
### Lambda list
```cl
(sb-bsd-sockets-internal::af sb-bsd-sockets-internal::src sb-bsd-sockets-internal::dst
 sb-bsd-sockets-internal::size)
```
